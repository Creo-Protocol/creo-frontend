...
const socials = [
  { label: "X", Icon: XIcon, href: "https://x.com/kreofinance" },
  { label: "Discord", Icon: DiscordIcon, href: "https://discord.gg/kreofinance" },
  { label: "GitHub", Icon: GitHubIcon, href: "https://github.com/Kreo-Finance" },
  { label: "YouTube", Icon: YouTubeIcon, href: "https://youtube.com/@KreoFinance" },
];
    ...
    <footer className="border-t border-border bg-background">
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="mt-16 flex flex-col items-center justify-between gap-4 border-t border-border pt-8 md:flex-row">
          ...
          <span className="font-body text-xs text-muted-foreground">
            Built with ❤️ by Team Kreo Finance
          </span>
        </div>
      </div>
    </footer>
